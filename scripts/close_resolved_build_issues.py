...
def _issue_resolved(issue: dict, report: dict) -> bool:
    """Return whether this specific auto-generated issue is resolved by report.

    Feature issues must be evaluated individually. A successful app/source may
    still have a real unsupported/failed feature while old report-only
    [runtime-skipped*] issues for other features should be closed.
    """
